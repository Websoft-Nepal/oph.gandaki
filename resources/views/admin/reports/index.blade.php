        ...
        <div id="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="container-fluid">
                    ...
                    <h2 class="fw-bold">{{ __('Report') }}</h2>

                    <a class="btn btn-info" href="{{ route('reports.create') }}">{{ __('Add Report') }}</a>
                            ...
                            <tbody>
                                @foreach ($reports as $key => $report)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a target="_blank" class="btn btn-info mx-1" href="{{ asset('site/uploads/report/'. $report->link) }}">View</a>
