                    ...
                    <div class="mx-5">
                        ...
                        <form method="post" action="{{ route('leaders.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="birth_place" value="{{ old('birth_place') }}" name="birth_place" placeholder="Enter your place of birth">
                            </div>
                            <div class="form-group">
                                @error('photo')
                                    <div class="bg-danger text-white p-2">{{ $message }}</div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="father_name" value="{{ old('father_name') }}" id="father_name" placeholder="Enter your father's name">
                            </div>
                            <div class="form-group">
                                <label for="mother_name">Mother's Name:</label>
                                <input type="text" class="form-control"name="mother_name" value="{{ old('mother_name') }}" id="mother_name" placeholder="Enter your mother's name">
                            </div>
                            <div class="form-group">
                                <label for="contact_no">Contact Number:</label>
                                <input type="tel" class="form-control" name="contact_no" value="{{ old('contact_no') }}" id="contact_no" placeholder="Enter your contact number">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="qualification" value="{{ old('qualification') }}" id="qualification" placeholder="Enter your qualification">
                            </div>
                            <div class="form-group">
                                <label for="work_exp">Work Experience:</label>
                                <input type="text" class="form-control" name="work_exp" id="work_exp" value="{{ old('work_exp') }}" placeholder="Enter your work experience">
                            </div>
                            <div class="form-group">
                                <label for="political_affairs">Political Affairs:</label>
                                <textarea class="form-control" id="political_affairs" name="political_affairs" rows="3" placeholder="Enter your political affairs">{{ old('political_affairs') }}</textarea>
                            </div>
                            <div class="form-group">
